...
export const Game = () => {
  ...
  return (
    <div>
      ...
      <p>
        Ready to make some money? Enter the amount to bet and
        the coin side.
      </p>
      <p>Good luck!</p>
      <p
      ...
      >
        Note: the result might take up to a few minutes.
        Just go grab a coffee and relax, you will get notified once the flip is over.
        In the meantime, you can play as many coins as you want!
      </p>
      <p>
